export default function CabeceraAdopcion() {
  ...
  return (
    <>
      <div className="max-w-container_max mx-auto px-gutter text-center">
            <h1 className="font-h1 text-h1 text-on-surface mb-sm">¡No compres, adoptá!</h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto text-justify">
                  La adopción es un acto de amor. Enseñale a tus hijos a valorar la vida, a respetar, cuidar y responsabilizarse de un ser que los amará toda su vida, y luego de ella. Ayudanos a luchar contra el abandono.
                </p>
