...
const OverlappingImagesSection = () => (
    <div className="flex flex-col md:flex-row items-center gap-10 p-8 md:p-12 bg-green-50/50 rounded-2xl max-w-6xl mx-auto mt-8">
        ...
        <div className="relative w-full max-w-[450px] mx-auto min-h-[380px] mt-8 mb-12">
            <div className="absolute top-0 left-4 w-[260px] group z-10">
                <div className="bg-[#fcfbf9] p-3 pb-8 shadow-xl border border-stone-200 transform rotate-3 transition-transform duration-500 group-hover:scale-105 group-hover:rotate-1">
                    <img
                        src="./animal4.jpeg"
                        alt="Actividad en el refugio 1"
                        className="w-full aspect-square object-cover sepia-[0.15] contrast-125 brightness-95"
                    />
                </div>
            </div>

            <div className="absolute top-12 right-4 w-[260px] group z-20">
                <div className="bg-[#fcfbf9] p-3 pb-8 shadow-2xl border border-stone-200 transform -rotate-3 transition-transform duration-500 group-hover:scale-105 group-hover:-rotate-1">
                    <img
                        src="./animal2.jpeg"
