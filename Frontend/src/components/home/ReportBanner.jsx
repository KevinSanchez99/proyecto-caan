    ...
    <div className="flex items-start gap-4">
        ...
        <div>
            ...
            <p className="font-body-md text-on-surface-variant text-xl md:text-base">
                Te explicaremo el procedimiento legal exacto para que tu denuncia sea válida.
            </p>
        </div>
    </div>
        <a href="/reports"
            className="w-full md:w-auto shrink-0 px-8 py-3 bg-error text-on-error font-label-xl text-label-xl rounded-full hover:shadow-md hover:scale-[1.02] transition-all text-center">
            Ver cómo denunciar
        </a>
    </div>
    );
